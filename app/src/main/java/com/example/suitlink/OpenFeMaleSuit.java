...
public class OpenFeMaleSuit extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.open_female_suit);

        previous = findViewById(R.id.imagePrevious);
        pager=findViewById(R.id.officepager);

        OpenFemaleSuitAdapter adapter = new OpenFemaleSuitAdapter(getLayoutInflater(),OpenFeMaleSuit.this);
