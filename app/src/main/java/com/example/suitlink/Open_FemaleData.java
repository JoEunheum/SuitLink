...
public class Open_FemaleData extends BaseActivity implements DatePickerDialog.OnDateSetListener{
    private final String TAG = "Open_FemaleData";
    ...
    private CheckBox jacket, chest, pents, shoes;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.open_female_data);
        ...
        arrayAdapter = new ArrayAdapter<>(Open_FemaleData.this,android.R.layout.simple_spinner_item,arrayList);
        ...
        rent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(textprice.getText().toString().equals("0 원")){
                    Toast.makeText(Open_FemaleData.this,"대여 할 상품을 선택해주세요.",Toast.LENGTH_SHORT).show();
                    return;
                }else {
                    price= textprice.getText().toString();
                }
                if(editsize.getText().toString().equals("")){
                    Toast.makeText(Open_FemaleData.this,"사이즈를 입력해주세요.",Toast.LENGTH_SHORT).show();
                    return;
                }else{
                ...
                if (radioHome.isChecked() == false && radioDelivery.isChecked() == false) {
                    Toast.makeText(Open_FemaleData.this, "대여방법을 정해주세요.", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(Open_FemaleData.this,rental_how+"로 대여되었습니다.",Toast.LENGTH_SHORT).show();
