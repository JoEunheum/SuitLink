...
public class Wing_MaleData extends BaseActivity implements DatePickerDialog.OnDateSetListener{
    private final String TAG = "Wing_MaleData";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wing_male_data);
        ...
        arrayAdapter = new ArrayAdapter<>(Wing_MaleData.this,android.R.layout.simple_spinner_item,arrayList);
        ...
        rent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jacket.isChecked() == false && chest.isChecked() == false && pents.isChecked() == false && shoes.isChecked() == false && tie.isChecked() == false&&belt.isChecked()==false) {
                    Toast.makeText(Wing_MaleData.this, "구분을 정해주세요.", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(editsize.getText().toString().equals("")){
                    Toast.makeText(Wing_MaleData.this,"사이즈를 입력해주세요.",Toast.LENGTH_SHORT).show();
                    return;
                }else{
                ...
                if (radioHome.isChecked() == false && radioDelivery.isChecked() == false) {
                    Toast.makeText(Wing_MaleData.this, "대여방법을 정해주세요.", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(Wing_MaleData.this,rental_how+"로 대여되었습니다.",Toast.LENGTH_SHORT).show();
