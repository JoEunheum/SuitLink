...
public class OpenFemaleSuitAdapter extends PagerAdapter {
    private static final String TAG = "OpenFemaleSuitAdapter";
    private LayoutInflater inflater;
    private Context context;


    public OpenFemaleSuitAdapter(LayoutInflater inflater, Context context) {
    ...
    public Object instantiateItem(final ViewGroup container, final int position) {
        ...
        img.setImageResource(R.drawable.femalesuit1+position);

        final int femalesuit = R.drawable.femalesuit1+position;
