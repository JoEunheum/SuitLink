...
public class Wing_FemaleData extends BaseActivity implements DatePickerDialog.OnDateSetListener{
    private final String TAG = "Wing_FemaleData";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wing_female_data);
        ...
        arrayAdapter = new ArrayAdapter<>(Wing_FemaleData.this,android.R.layout.simple_spinner_item,arrayList);
    ...
    protected void onResume() {
        ...
        rent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jacket.isChecked() == false && chest.isChecked() == false && pents.isChecked() == false && shoes.isChecked() == false && tie.isChecked() == false&&belt.isChecked()==false) {
                    Toast.makeText(Wing_FemaleData.this, "구분을 정해주세요.", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(editsize.getText().toString().equals("")){
                    Toast.makeText(Wing_FemaleData.this,"사이즈를 입력해주세요.",Toast.LENGTH_SHORT).show();
                    return;
                }else{
                ...
                if (radioHome.isChecked() == false && radioDelivery.isChecked() == false) {
                    Toast.makeText(Wing_FemaleData.this, "대여방법을 정해주세요.", Toast.LENGTH_SHORT).show();
                ...
                Post office = new Post(size , color, "0 원", office_address, office_number, rental_time, rental_how, office_name, division, office_name , suitimage, "rent");
                ...
                Toast.makeText(Wing_FemaleData.this,rental_how+"로 대여되었습니다.",Toast.LENGTH_SHORT).show();
